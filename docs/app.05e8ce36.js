      ...
      function(require, module, exports) {
        ...
        !(function() {
          ...
          function u(t, n, i) {
            ...
            n = r(t, 'link', {rel: 'stylesheet', href: n, media: 'all'})
            var o = !1,
              a = !0,
              c = null,
              h = i || null
          ...
          function L(t) {
            var n,
              i = t.g.a.offsetWidth,
              a = t.h.a.offsetWidth
            ;(n = i === t.f.serif && a === t.f['sans-serif']) ||
              (n = P() && B(t, i, a)),
              n
                ? o() - t.A >= t.w
                  ? P() &&
              ...
              setTimeout(function() {
                ...
                if (0 === i.length && s) T(n.a)
                  ...
                  for (f = 0; f < i.length; f++) {
                    ...
                    if (
                      (p.g &&
                        h(p.f, [p.a.c('wf', g.c, x(g).toString(), 'loading')]),
                      S(p, 'fontloading', g),
                      (p = null),
                      null === q)
                    )
                    ...
                    ;(p = q
                      ? new W(e(n.g, n), e(n.h, n), n.c, l, n.s, u)
                      : new F(e(n.g, n), e(n.h, n), n.c, l, n.s, t, u)),
                      c.push(p)
                  }
          ...
          ;($.prototype.g = function(t) {
            ...
            (K.prototype.load = function(t) {
              var n,
                ...
                s = new g()
              for (n = 0, i = e.length; n < i; n++) u(this.c, e[n], d(s))
              var r = []
          ...
          var e = document.querySelector('.suggestions'),
            r = [].concat(
              o(
                new Set(
                  [].concat(
                    o(require('./words/80s.json')),
                    o(require('./words/slang.json')),
                    o(require('./words/synthwave.json'))
                  )
                )
              )
            ),
            t = [].concat(o(Array(r.length).keys())),
            s = []
          ;[].concat(o(Array(1).keys())).map(function(o) {
            var u = document.createElement('li'),
              i = (0, n.default)(t).slice(0, 2)
            ;(u.className =
              'suggestions__suggestion suggestions__suggestion--' + o),
              e.appendChild(u),
              s.push(r[i[0]] + ' ' + r[i[1]])
          }),
            s.map(function(e, r) {
              var t = document.querySelector(
                '.suggestions__suggestion.suggestions__suggestion--' + r
              )
              ;(t.innerText = e),
                (t.style.height = window.getComputedStyle(t, null).width)
            })
        }
        r.default.load({google: {families: ['Orbitron:900']}, active: u})
      },
      {
        webfontloader: 'FryP',
        './shuffle': 'aWYP',
        './words/80s.json': '82lS',
        './words/slang.json': 'bEym',
        './words/synthwave.json': 'H3f1'
      }
    ]
  },
  {},
